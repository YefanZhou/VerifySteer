...
@register_algorithm("norm_direct")
class NormalizeDirectAlgorithm(AlgorithmTemplate):
    ...
    def load_from_path(cls, path: str, device: str, **kwargs) -> dict:
        ...
        if config is None:
            raise ValueError("NormalizeDirectAlgorithm.load_from_path requires 'config' in kwargs")
